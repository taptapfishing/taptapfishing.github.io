...
fishingGame.Preloader.prototype = {
    ...
    this.load.spritesheet('fishB','assets/fishB.png',60,45);
		...
		this.load.spritesheet('decoFishOld','assets/fishBG.png',120,45);
    ...
    this.load.image('laneLine','assets/laneLine.png');
		this.load.spritesheet('gamebg','assets/gamebg.png',400,600);
		this.load.image('fishingRod','assets/fishingRod.png');

		//this.load.spritesheet('tutorial1','letterB1.png',400,600);
		//this.load.spritesheet('tutorial2','assets/gui/letterB2.png',120,45);
